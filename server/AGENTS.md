...
- Physical library kinds use canonical Modelica wrappers. Signal/state definitions are bounded snippets. Preserve connection laws and surface compiler diagnostics rather than guessing execution order.
